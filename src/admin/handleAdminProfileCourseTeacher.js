...
export default function handleAdminProfileCourseTeacher(req, res) {
...
async function student(httpRequest) {
    switch (httpRequest.method) {
        case 'POST':
            return createCourseTeacher(httpRequest)
    ...
    async function createCourseTeacher(httpRequest) { // данные запроса в виде obj
        ...
        VALUES (?, ?)`,
        [httpRequest.body.teacher_id, httpRequest.body.course_id]);
